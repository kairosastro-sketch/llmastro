...
import Script from "next/script"; // HOTFIX-THEME-SCRIPT-V1
import "./globals.css";
    ...
    <html lang="fr" data-theme="dark" suppressHydrationWarning>
      <head>
        {/*
          ...
          HOTFIX-THEME-SCRIPT-V1 : via next/script beforeInteractive plutôt
          qu'un <script> brut — sous React 19 / Next 16, un <script> exécutable
          rendu dans un composant déclenche un console.error (« script tag
          while rendering ») qui fait apparaître l'overlay d'erreur dev.
        */}
        <Script
          id="theme-init"
