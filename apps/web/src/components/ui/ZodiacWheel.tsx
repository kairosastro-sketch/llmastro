      ...
      >
        ...
        >
          ...
          {layerAspects && layerPlanets && aspects.map(({ p1, p2, rule }, i) => {
            ...
            // dessus) → jonction nette. On visait avant la vraie longitude sur
            // un moyeu interne (R_ASPECT) : pour des astres resserrés puis
            // écartés (ex. Lilith/Pallas), le trait flottait à côté du glyphe
            // nudgé. displayLongitude + R_NATAL/R_TRANSIT le règle.
