...
// Affiche :
//   1. Disclaimer IA proéminent (Kairos, calculs vérifiables)
...
function disclaimerText(kind: KairosTraceProps["readingKind"], locale: string): {
  ...
  if (isFr) {
    const introByKind: Record<string, string> = {
      "horoscope":
        "Cette lecture a été générée par Kairos à partir des positions astrologiques calculées de votre thème natal et des transits du moment.",
      "tarot":
        "Cette interprétation a été générée par Kairos en croisant les cartes tirées et, le cas échéant, votre thème natal.",
      "natal-profile":
        "Ce profil natal a été généré par Kairos à partir des positions astrologiques calculées de votre thème.",
      "chat":
        "Cette réponse a été générée par Kairos dans le contexte de votre thème natal.",
      "generic":
        "Ce contenu a été généré par Kairos à partir des données astrologiques calculées.",
    };
    return {
  ...
  const introByKindEn: Record<string, string> = {
    "horoscope":
      "This reading was generated by Kairos from the calculated astrological positions of your natal chart and current transits.",
    "tarot":
      "This interpretation was generated by Kairos from the drawn cards and, if available, your natal chart.",
    "natal-profile":
      "This natal profile was generated by Kairos from the calculated astrological positions of your chart.",
    "chat":
      "This response was generated by Kairos in the context of your natal chart.",
    "generic":
      "This content was generated by Kairos from calculated astrological data.",
  };
  return {
