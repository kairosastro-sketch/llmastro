...
// Indicateur de quota de sauvegardes pour les tirages de tarot.
// Miroir de ChatQuotaIndicator.
//
// 4 états visuels :
//  1. quota null (loading) → "…" muted
//  2. limit === -1 (illimité, Pro) → "Sauvegardes illimitées" en or
//  3. free + quota épuisée → bouton "1/1 — Essentiel pour plus" cliquable
//  4. cas standard (free avec capacité, ou Essentiel) → "Sauvegardes : N/M"
...
export function TarotQuotaIndicator({
  quota,
  isFree,
  locale,
  onUpgradeClick,
