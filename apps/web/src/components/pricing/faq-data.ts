...
export const FAQ_ENTRIES: FAQEntry[] = [
  {
    ...
    a: "Oui, à tout moment. Tu peux passer de Découverte à Essentiel, ou inversement, et tes données restent intactes. La différence de prix est ajustée au prorata, automatiquement, au prochain renouvellement.",
  },
  {
    q: "Comment fonctionne l'essai gratuit ?",
    a: "À la création de ton compte, tu bénéficies de 7 jours d'accès complet au plan Essentiel. Aucun moyen de paiement n'est demandé pour démarrer. À l'issue, tu repasses automatiquement sur Découverte (gratuit) si tu n'as pas activé ton abonnement.",
  },
  {
