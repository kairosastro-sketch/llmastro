-- PROMO-CODES-V1
-- Codes promo internes : offrir N jours d'un plan ou des crédits feature.
-- Stripe coupons délibérément hors scope (voir CLAUDE.md / discussion).
-- Source de vérité runtime = boot/init-promo-codes.ts ; ce .sql est historique.
