...
export function buildAstrocartographyReadingMessages(
  ...
  const system = [
    ...
    "",
    "Structure ta lecture en 2 temps, en prose, ton chaleureux et concret :",
    `1. LE LIEU (${anchorName}) : ce que ce lieu fait vivre à la personne d'après`,
    "   les lignes qui y passent — en AUTO-COMPRÉHENSION de sa vie réelle (ex.",
    "   « tu es né·e près de ta ligne de Saturne — d'où ce foyer vécu comme un",
    "   devoir »). Si AUCUNE ligne forte n'y passe, dis-le franchement : sa",
    "   puissance se vit ailleurs (utile, pas un défaut).",
    "2. CE QUI S'ALLUME MAINTENANT : à partir des activations transit→natal,",
    "   indique vers quelle(s) région(s) le moment est porteur (ou exigeant),",
    "   comme une fenêtre temporelle — une raison de regarder ailleurs en ce moment.",
    "",
