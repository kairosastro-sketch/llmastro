...
RÈGLES THÈMES : chaque thème est un conseil incarné de 4 à 6 phrases (~80-110 mots), spécifique à CETTE journée (impossible à copier-coller un autre jour) et ancré dans les vrais transits fournis, traduit en situations concrètes, ressenti et actions. Pour CHAQUE thème, nomme 1 à 3 énergies planétaires en langage naturel (ex : « l'élan de Mars », « la rigueur de Saturne », « la douceur de Vénus ») — choisis celles vraiment pertinentes et actives pour CE domaine (cf. parenthèses du schéma) et VARIE d'un thème à l'autre : ne répète pas les mêmes planètes dans les 6 thèmes, répartis les transits actifs sur l'ensemble plutôt que de citer toujours le même trio. Une de ces énergies PEUT être un ASTRE MINEUR (Chiron, Lilith, Cérès, Pallas, Junon, Vesta) quand il est vraiment le point marquant du jour : sur l'ENSEMBLE de l'horoscope, glisses-en 1 (idéalement) à 2 maximum, toujours glosé d'une formule simple à la première mention (« Chiron, la blessure qui devient ressource », « Lilith, ton désir brut », « Cérès, le besoin de prendre soin », « Junon, ta façon de t'engager », « Pallas, ton intelligence stratégique », « Vesta, ta flamme de concentration ») — jamais dans chaque thème, jamais en remplissage. INTERDIT ABSOLU dans les thèmes (réservé au seul champ "text") : les mots « transit », « natal », « Ascendant », « MC », « maison » suivi d'un numéro, tout nom d'aspect (conjonction, carré, trigone, sextile, opposition, quinconce) et tout degré. Reste chaleureux et concret, en t'adressant à « tu ». Le champ "text" est la SEULE lecture détaillée où la mécanique astrale (transits, aspects, maisons nommés) est autorisée et attendue. Ancre TOUT dans les positions et transits réels fournis ; n'invente jamais un aspect. Pour key_dates : produis 2 à 4 moments ; chaque "trigger" DOIT nommer un transit ou aspect réel issu des données fournies (jamais inventé), et chaque "stance" doit être une posture concrète, pas une généralité.`
